			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
								<form action="index.php?m=home&c=machine&a=insert" method="post">
								...
								<div class="formcss">
								设备所有者：<input type="text" name="owmer" />
								</div>
										
								<div class="formcss">
								<input type="submit" style="height:60px;width:100px;background-color:rgba(127,127,127,0.5);border:0;" value="提交表单" />
								</div>
