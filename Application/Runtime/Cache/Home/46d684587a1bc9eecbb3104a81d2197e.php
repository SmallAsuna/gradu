...
<html lang="en">
	<head>
		...
		.button1css{display: inline-block;width: 65px;height: 25px;background-color: rgba(18,222,54,0.7);border: 0px;color: white;}
							...
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody id="displaytbody">
													<tr id="displaytable">
														...
														<td>
													<a class="blue1" href="#" title="查看手册" class="button1css">
												    <button class="button1css">申请使用</button>
												    </a>
														   <a class="blue2" href="#" title="查看手册" class="button1css">
														  <button class="button1css">查看详情</button>
														   </a>
